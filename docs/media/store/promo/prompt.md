# chrome web store promo prompts

## small-promo

```markdown
A professional 440x280 pixel promotional tile for Chrome Extension "Ophel Atlas".
...
- Background: Deep purple and blue aurora gradient, dark mode aesthetic, premium frosted glass texture (glassmorphism).
- Typography: Sans-serif, high contrast, white text on dark background, strictly legible.
- Vibe: High-tech, trustworthy, productive, software interface style.
