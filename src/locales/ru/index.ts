export const ru = {
  ...
  tip5: "Устанавливайте пакеты сайтов, чтобы использовать Ophel на других ИИ-сайтах",
  ...
  promptPlatformFilter: "Фильтр по платформе",
  promptPlatformCurrent: "Текущая платформа",
  promptPlatformLabel: "Поддерживаемые платформы",
  promptPlatformAll: "Все платформы",
  promptPlatformSearch: "Поиск платформ",
  promptPlatformNoMatches: "Подходящие платформы не найдены",
