export const ko = {
  ...
  promptPlatformFilter: "플랫폼으로 필터링",
  promptPlatformCurrent: "현재 플랫폼",
  promptPlatformLabel: "지원 플랫폼",
  promptPlatformAll: "모든 플랫폼",
  promptPlatformSearch: "플랫폼 검색",
  promptPlatformNoMatches: "일치하는 플랫폼이 없습니다",
...
최적화된 코드 블록을 직접 출력하고, 그 뒤에 개선 사항을 간략히 요약해 주세요.`,
  ...
  "featureTip-global-search-desc": "folder: tag: level: 필터 구문으로 콘텐츠 정밀 검색",
  "featureTip-global-search-path": "{shortcut}으로 검색 열기 — folder: tag: level: 구문 지원",
  ...
  "featureTip-export-conv-desc": "선택한 대화를 Markdown / JSON / TXT로 내보내기",
