export const ja = {
  ...
  tip2: "タイトルバーをダブルクリックでプライバシーモードを切り替え",
...
最適化されたコードブロックを直接出力し、その後に改善点の簡潔な要約を添えてください。`,
  ...
  "featureTip-privacy-mode-title": "プライバシーモード",
  "featureTip-privacy-mode-desc": "会話タイトルを非表示にして画面を保護",
  "featureTip-privacy-mode-path": "パネルのタイトルバーをダブルクリックで切り替え",
