export const ja = {
  ...
  promptPlatformFilter: "プラットフォームで絞り込み",
  promptPlatformCurrent: "現在のプラットフォーム",
  promptPlatformLabel: "対応プラットフォーム",
  promptPlatformAll: "すべてのプラットフォーム",
  promptPlatformSearch: "プラットフォームを検索",
  promptPlatformNoMatches: "一致するプラットフォームがありません",
...
最適化されたコードブロックを直接出力し、その後に改善点の簡潔な要約を添えてください。`,
  ...
  "featureTip-global-search-desc": "folder: tag: level: フィルター構文でコンテンツを絞り込む",
  "featureTip-global-search-path": "{shortcut}で検索を開く — folder: tag: level: 構文対応",
  ...
  "featureTip-export-conv-desc": "選択した会話をMarkdown / JSON / TXT形式でエクスポート",
