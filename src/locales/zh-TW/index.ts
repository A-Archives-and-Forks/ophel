export const zhTW = {
  ...
  voyagerImportTitle: "從 Gemini Voyager 匯入",
  voyagerImportDesc: "匯入資料夾整理結果，並增量合併到目前帳號",
  voyagerImportAction: "開始匯入",
  voyagerImportPlaceholder:
    "貼上 Gemini Voyager 匯出的 JSON 內容，例如 gemini-voyager.folders.v1 ...",
  voyagerImportConfirm: "確認將 Voyager 資料夾結構增量匯入到目前開啟的 Gemini 帳號？",
  voyagerImportVersion: "Voyager 版本",
  voyagerImportFolderCount: "資料夾",
  voyagerImportConversationCount: "對話",
  voyagerImportNewFolders: "新增資料夾",
  voyagerImportNewConversations: "新增對話",
  voyagerImportMovedConversations: "移動對話",
  voyagerImportPreservedConversations: "保留原資料夾",
  voyagerImportFlattenNotice: "階層資料夾會壓平成路徑名稱，例如「父層 / 子層」。",
  voyagerImportMergeNotice:
    "為避免覆蓋現有整理結果，已放入其他 Ophel 資料夾的對話會保留原位；只有收件箱和先前匯入的 Voyager 資料夾會重新歸類。",
  voyagerImportSuccess:
    "Voyager 匯入完成：新增 {folders} 個資料夾，新增 {conversations} 個對話，移動 {moved} 個對話。",
  voyagerImportGeminiOnly: "請在 Gemini 頁面開啟資料管理後再執行 Voyager 匯入。",
  voyagerImportGeminiHint:
    "僅支援 `gemini-voyager.folders.v1` JSON。匯入內容會自動歸入目前開啟的 Gemini 帳號。",
  voyagerImportPasteRequired: "請先選擇 Voyager 檔案或貼上 JSON 內容",
  voyagerImportInvalidFormat: "這不是 Gemini Voyager 的資料夾匯出格式",
  voyagerImportInvalidData: "缺少有效的資料夾或內容資料",
  voyagerImportEmpty: "匯入檔案中沒有可用的資料夾",
...
請直接輸出優化後的程式碼區塊，並在後面附帶簡短的優化點總結。`,
  ...
  "featureTip-privacy-mode-title": "隱私模式",
  "featureTip-privacy-mode-desc": "隱藏對話標題，避免畫面被旁人看到",
  "featureTip-privacy-mode-path": "雙擊面板標題列即可切換",
